...
namespace Practice.HR
{
    ...
    public static class Builders
    {
        ...
        internal class ClientBuilder1 : IClientBuilder
        {
            ...
            public IClientBuilder Name(string name, string sur, string patr)
            {
                client.Name = new Name(name, sur, patr);
                return this;
            }
            }
         ...
         internal class EmployeeBuilder1 : IEmployeeBuilder
        {
            ...
            public IEmployeeBuilder Name(string name, string sur, string patr)
            {
                employee.Name = new Name(name, sur, patr);
                return this;
            }
        }
